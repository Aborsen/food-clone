...
def welcome_message(first_name: str | None = None) -> str:
    ...
    return (
        f"Привіт, <b>{name}</b>! 🥗\n\n"
        f"Я твій особистий трекер їжі — дружній до Крона й суворий до алергенів. Я вмію:\n"
        f"• рахувати калорії та БЖВ 🔥\n"
        f"• махати червоним прапорцем над помідорами, глютеном та іншими «ні-ні» 🚩\n"
        f"• підказувати, чи сподобається страва твоєму кишечнику 🫀\n"
        f"• ввечері робити підсумок дня і давати поради на завтра 🌙\n\n"
